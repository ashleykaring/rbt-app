...
function EntryPage() {
    ...
    const [wordLimitError, setWordLimitError] = useState(""); // State for word limit error
    ...
    const handleInputChange = (e) => {
        ...
        const limitedValue = limitWords(value, WORD_LIMIT); 
 
        if (value.trim().split(/\s+/).length > WORD_LIMIT) {
            setWordLimitError(`The ${name} field can only contain up to ${WORD_LIMIT} words.`);
        } else {
            setWordLimitError(""); // Clear error message when within the limit
        }
        console.log(wordLimitError);
                        ...
                        {isEditing ? (
                            <>
                                <div className="entry-item">
                                    ...
                                    />
                                    {wordLimitError && <p className="error-message">{wordLimitError}</p>}
                                </div>
                                <div className="entry-item">
                                    <h3>Bud</h3>
                                    <input
                                ...
                                <div className="entry-item">
                                    ...
                                    />
                                    {wordLimitError && <p clasNmae="error-message">{wordLimitError}</p>}
                                </div>
